...
class sinc_ctc_att(sb.Brain):
    def compute_forward(self, batch, stage):
        ...
        #Sincnet
        feats = self.modules.normalize(wavs, wav_lens)
        feats_sinc = self.modules.sincconv_raw(feats)
...
# Functions cited from https://github.com/speechbrain/speechbrain/blob/develop/recipes/TIMIT/ASR/seq2seq/train.py
