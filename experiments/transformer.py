...
def dataio_prep(hparams):
    ...
    def text_pipeline(phn):
        ...
        yield phn_encoded
        phn_encoded_eos = torch.LongTensor(label_encoder.append_eos_index(phn_encoded_list))
        yield phn_encoded_eos
        phn_encoded_bos = torch.LongTensor(label_encoder.prepend_bos_index(phn_encoded_list))
...
def run_experiment(hparams_file, run_opts, overrides=""):
    global hparams, label_encoder, asr_brain
    # Load hyperparameters file with command-line overrides
    with open(hparams_file) as fin:
        hparams = load_hyperpyyaml(fin, overrides)
    # Dataset prep (parsing TIMIT and annotation into csv files)
    from data.timit_prepare import prepare_timit  # noqa
...
if __name__ == "__main__":
    ...
    run_experiment(hparams_file, run_opts, overrides)
